...
| [gpu-vram-monitoring.md](services/gpu-vram-monitoring.md) | Per-container GPU VRAM monitoring for forge/t5 (1660 Super) — t5-host collector → Prometheus/Grafana dashboard `gpu-forge` + >90% alert rule (Grafana UI only, no notification channel) |
